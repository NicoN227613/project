 ...
 */
final class Version20200427143617 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE classified_in_id classified_in_id INT NOT NULL, CHANGE place_in_id place_in_id INT NOT NULL, CHANGE units_id units_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE classified_in_id classified_in_id INT DEFAULT NULL, CHANGE place_in_id place_in_id INT DEFAULT NULL, CHANGE units_id units_id INT DEFAULT NULL');
