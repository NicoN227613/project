 ...
 */
final class Version20200513152332 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE expiration_date expiration_date DATETIME DEFAULT NULL, CHANGE best_before_date best_before_date DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
